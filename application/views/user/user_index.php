                                ...
                                <?php foreach ($allUser as $user) { ?>
                                    <div class="col-6 col-sm-2 col-lg-2 mb-4 mb-md-0">
                                        <div class="avatar-item">
                                            <a href="<?= base_url('user/profile/' . encode($user['email'])); ?>">
                                                <img class="img-responsive" id="image-responsive" alt="image" src="<?= base_url('uploads/images/' . $user['image']); ?>" class="img-fluid" data-toggle="tooltip" title="" data-original-title="<?= $user['name'] ?>">
                                            </a>
