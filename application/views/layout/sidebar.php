...
<aside class="main-sidebar sidebar-light-indigo elevation-4" style="background-color: #D9E1EA;">
	<!-- Brand Logo -->
	<a href="<?= base_url('/'); ?>" class="brand-link">
		<img src="<?= base_url(); ?>public/assets/dist/img/puskesmas.png" alt="Puskesmas logo" class="brand-image img-circle elevation-3" style="opacity: .8">
		<span class="brand-text font-weight-light">Puskesmas Berseri</span>
	</a>
